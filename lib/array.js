...
internals.Array.prototype.describe = function () {
    ...
    if (this._inner.inclusions.length ||
        ...
        var inclusions = [].concat(this._inner.inclusions, this._inner.requireds);

        for (var i = 0, il = inclusions.length; i < il; ++i) {
            description.includes.push(inclusions[i].describe());
        }
    }
...
internals.Array.prototype.includes = internals.Array.prototype.items = function () {
